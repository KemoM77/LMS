  ...
  return ( open &&
    <div
      className={classNames({
        ...
        'border-t-[0.5px] shadow-sm bg-[#07074c] text-zinc-50 ': true, // colors
        'sticky max-[800px]:fixed top-16 z-10 max-[600px]:z-20  max-[600px]:top-14': true, // positioning
        'min-h-[calc(100vh_-_64px)] max-[600px]:min-h-[calc(100vh_-_54px)]': true,
        'min-[800px]:w-[300px] w-[250px] ': open,
      ...
      <div className="border-t border-t-indigo-800 p-4 ">
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-row items-center justify-between gap-12 min-[800px]:gap-20">
            ...
            <LogoutIcon tabIndex={0} onClick={handleSignout} className="cursor-pointer duration-300 opacity-100 " />
          </div>
        </div>
      </div>
    </div>
